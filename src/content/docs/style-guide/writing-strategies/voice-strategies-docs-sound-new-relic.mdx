    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            New Relic offers a fast, scalable <InlinePopover type="logs" /> platform that allows you to connect your logs with the rest of your telemetry and infrastructure data.
...
* **[Avoid ableist language](/docs/style-guide/writing-strategies/writing-inclusive-content/)**. Terms like "crazy" or "dumb" or "blind" might seem innocuous, but are not.
